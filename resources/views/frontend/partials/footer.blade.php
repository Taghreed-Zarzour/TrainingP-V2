...
<footer class="border-top pt-3">
    <div class="container   pt-4">
        <div class="row g-4 justify-content-between"> <!-- استخدام g-4 لضبط المسافات بين الأعمدة -->
            ...
            <div class="col-lg-3 col-md-6 footer-col">
                ...
                <p class="text-muted text-justify footer-text mt-3">
                    كل ما تحتاجه لتبدأ تدريبك بسرعة، وتصل إلى
                    المتدربين المهتمين بسهولة، وتبدأ في تحقيق دخل
                    إضافي، في منصة رقمية واحدة تُشكل منظومة متكاملة
                    للتدريب المباشر.
                </p>
            </div>
            ...
            <div class="col-lg-2 col-md-6 footer-col">
                ...
                <div class="footer-links">
                    ...
                    @endphp
                    <a href="{{ route($homeRoute) }}{{ !$isOrg && !auth()->check() ? '?type=individual' : ($isOrg && !auth()->check() ? '?type=organization' : '') }}">الرئيسية</a>
                    <a href="{{ route('trainings_announcements') }}">التدريبات</a>
                    <a href="{{ route('trainers.index') }}">المدربون</a>
                    <a href="{{ route('assistants.index') }}">شركاء التدريب</a>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-6 footer-col">
                ...
                <div class="footer-links">
                    ...
                    @endphp
                    <a href="{{ route($subscriptionsRoute) }}{{ !$isOrg && !auth()->check() ? '?type=individual' : ($isOrg && !auth()->check() ? '?type=organization' : '') }}">الباقات</a>
                    <a href="#">تواصل معنا</a>
            ...
            <div class="col-lg-3 col-md-6 footer-col">
                ...
                <div class="contact-info-footer">
                    ...
                    <a href="https://facebook.com/followtrainingp">
                        ...
                        <span dir="ltr">@FollowTrainingP</span>
                    </a>
    ...
    <div class="row align-items-center border-top pt-3 w-100">
        <div class="text-align-center footer-bottom">
      © TrainingP 2025.  جميع الحقوق محفوظة. 
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form class="p-0" id="feedbackForm" method="POST" action="{{ route('feedback.store') }}">
                @csrf
                <button type="button" class="btn-close align-self-end pt-4 pe-4" data-bs-dismiss="modal"
                ...
                <div class="modal-body text-center px-5 pt-0">
                    ...
                    <div class="d-flex flex-column gap-3">
                        <!-- زر الإرسال -->
                        <button type="submit"
                            class="custom-btn d-flex align-items-center justify-content-center gap-2 py-2">
                            <span>إرسال</span>
            ...
            fetch(feedbackForm.action, {
                ...
                .then(response => {
                    if (response.ok) {
                        ...
                        const feedbackModal = bootstrap.Modal.getInstance(document.getElementById(
                            'contactModal'));
                        feedbackModal.hide();

                        // فتح مودال الشكر
                        const thankYouModal = new bootstrap.Modal(document.getElementById(
                            'thankYouModal'));
                        thankYouModal.show();
