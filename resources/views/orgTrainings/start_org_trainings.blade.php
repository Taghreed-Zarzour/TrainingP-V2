        ...
        <section class="boarding-section" data-current-step="1">
            ...
            <div class="content">
                ...
                <div class="main">
                    ...
                    <div class="desc">
                        المسار التدريبي يمنح مؤسستك فرصة لتقديم رحلة تعلم متكاملة بدل تدريب منفصل. عبر تصميم مسار يضم عدة
                        تدريبات مترابطة، تساعد المتدربين على بناء مهارات أعمق وتزيد من جاذبية عرضك. </div>
                </div>
                <div class="footer">
