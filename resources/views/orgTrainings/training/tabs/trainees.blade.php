<!-- resources/views/orgTrainings/tabs/trainees.blade.php -->
<style>
    .tr-trainees-card {
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="tr-trainee-name">
                                        ...
                                        <span>
                                          {{-- {{ $trainee->user->getTranslation('name', 'ar') }}
                                ...
                                <td class="text-center">
                                    <form
                                        action="{{ route('acceptedTrainee.delete', ['trainee_id' => $trainee->id , 'program_id'=> $OrgProgramDetail->trainingProgram->id]) }}"
