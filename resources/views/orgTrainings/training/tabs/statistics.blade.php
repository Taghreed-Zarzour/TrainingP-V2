<!-- resources/views/orgTrainings/tabs/statistics.blade.php -->
<style>
    .stats-row {
        display: flex;
        flex-wrap: wrap;
    ...
    <div class="stats-row d-flex flex-wrap gap-3">
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value">{{ $OrgProgramDetail->trainingProgram->views ?? 0 }} مشاهدة</div>
            </div>
        </div>
        <div class="stat-card">
...
<script>
    ...
    const sessionCount = @json(count($OrgProgramDetail->trainingSchedules));
...
<script>
    ...
    const customLabel = {
        ...
        afterDatasetsDraw(chart) {
            ...
            const lineHeight = 18;
            const boxHeight = (titleLineCount * lineHeight) + 30 + 20;
