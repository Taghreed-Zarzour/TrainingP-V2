                          ...
                          <div
                              ...
                              <div class="d-flex align-items-center gap-3 ">
                                  ...
                                  <button class="btn-agree">
                                     قبول كل الأشخاص المحددين (33 متدرب)
                                  </button>
                              </div>
                      ...
                      <div class="trainees-container ">
                          <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-3 p-3" id="traineesGrid">
                              <!-- سيتم استبدال هذا الجزء بـ foreach في لارافل -->
                              <?php for($i = 0; $i < 4; $i++): ?>
                              <div class="col">
                                  <div class="card trainee-card position-relative">
                                      <!-- بطاقة صغيرة أعلى اليسار - جديد -->
                                      <div class="status-badge new">
                                          جديد
                                      </div>
                                      <div class="trainee-content align-content-center">
                                          <div class="trainee-info">
                                              <img src="{{ asset('images/icons/user.svg') }}" class="rounded-circle"
                                                  width="60" height="60">
                                              <div class="trainee-details">
                                                  <h5 class="mb-1">أحمد العوابدة</h5>
                                                  <p class="text-muted small mb-0">
                                                      سجّل بتاريخ 22/05/2025 
                                                    </p>
                                              </div>
                                          </div>
                                      </div>
                              ...
                              <div class="col">
                                  <div class="card trainee-card position-relative">
                                      ...
                                      <div class="trainee-actions">
                                          <button class="action-btn reject-reason-btn" data-bs-toggle="modal"
                                          ...
                                          <div class="accepted-label">
                                              <svg width="22" height="21" viewBox="0 0 22 21" fill="none"
                                                  ...
                                                  <path d="M3.67188 10.9961L7.94219 15.2368L17.5504 5.69531"
                                                      stroke="white" stroke-width="1.73481" stroke-linecap="round"
                                      ...
                                      <form id="rejectReasonForm" class="p-0" method="POST">
                                          ...
                                          <div class="form-group">
                                              <textarea class="form-control" id="rejectionReason" name="rejection_reason" rows="3" required
                                                  placeholder="يرجى توضيح سبب رفض الطلب لبنم إبلغ المتدرب بشكل مناسب."></textarea>
                                          </div>
                                      </form>
                                  </div>
                                  <div
                                      ...
                                      <button type="submit" form="rejectReasonForm"
                                          class="custom-btn btn-warning mx-2 flex-fill">
                                          إرسال السبب للمتدرب
    ...
    `;
                              ...
                              selectAllCheckbox.addEventListener('change', function() {
                                  ...
                                  document.querySelectorAll('.trainee-card.has-selection-circle').forEach(card => {
                              ...
                              // عند النقر على بطاقة متدرب جديد
                              document.querySelectorAll('.trainee-card.has-selection-circle').forEach(card => {
                                  card.addEventListener('click', function(e) {
                                      if (e.target.closest('.trainee-actions')) return;

                                      const circle = this.querySelector('.selection-circle');
                                      const isSelected = circle.style.display === 'block';
                              ...
                              function updateSelectAllCheckbox() {
                                  const selectableCards = document.querySelectorAll('.trainee-card.has-selection-circle');
                                  const selectedCards = document.querySelectorAll('.trainee-card.has-selection-circle.selected');

                                  selectAllCheckbox.checked = selectableCards.length > 0 && selectableCards.length === selectedCards
                                      .length;
                                  selectAllCheckbox.indeterminate = selectedCards.length > 0 && selectedCards.length < selectableCards
                                      .length;
                              }
                          });
                      </script>
