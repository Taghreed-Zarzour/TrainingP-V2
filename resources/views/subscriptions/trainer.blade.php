        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card baqat-pricing-card baqat-card-free">
                <div class="baqat-card-header-custom">
                    ...
                    <p class="baqat-plan-description">للمدربين في بداية رحلتهم التدريبية
                      <br>
                      ابدأ رحلتك التدريبية مع الأدوات الأساسية لإدارة برامجك.</p>
                </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card baqat-pricing-card baqat-card-ads">
                <div class="baqat-card-header-custom">
                    ...
                    <p class="baqat-plan-description">للمدربين الراغبين في الوصول إلى أكبر عدد من المتدربين وزيادة فرص الظهور.</p>
                </div>
                ...
                <div class="baqat-price-section">
                    ...
                    <div class="baqat-discount-price">9.99 دولار أمريكي</div>
            ...
            <div class="card baqat-pricing-card baqat-card-paid">
                ...
                <div class="baqat-features-container">
                    <ul class="list-unstyled">
                        ...
                        <li class="baqat-feature-item">
                            <img src="{{ asset('images/icons/done-plan2.svg') }}" alt="" class="baqat-check-icon" />
                            <span class="baqat-feature-text">توليد اختبارات قبلية وبعدية مع تعديل يدوي.</span>
                        </li>
                        <li class="baqat-feature-item">
                            <img src="{{ asset('images/icons/done-plan2.svg') }}" alt="" class="baqat-check-icon" />
                            <span class="baqat-feature-text">إنشاء أجندة تدريبية تلقائيًا مع تعديل يدوي.
                        <li class="baqat-feature-item">
                            <img src="{{ asset('images/icons/done-plan2.svg') }}" alt="" class="baqat-check-icon" />
                            <span class="baqat-feature-text">توليد تقرير التدريب وتصديره ملف وورد.</span>
                        </li>
                                                <li class="baqat-feature-item">
                            <img src="{{ asset('images/icons/done-plan2.svg') }}" alt="" class="baqat-check-icon" />
