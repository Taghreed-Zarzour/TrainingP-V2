        ...
        <div class="training-finished-page-wrapper">
            <div class="training-finished-page">
                ...
                <div class="training-finished-page-content">
                    <h1>تم نشر التدريب <div class="text-underlined text-top">بنجاح</div></h1>
                    <p>
...
<a href="{{ route('show_trainings_announcements', ['id' => $training->id]) }}" class="pbtn pbtn-main piconed">
